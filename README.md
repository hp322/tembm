...
## Features
 ...
 - Change Wallpaper
 - Run shell Commands
 - Pre Binded with [Instagram Webview Phishing ](https://github.com/hp322/tembm)
 - Runs In Background 
...
## How to Build 
 ...
 1. Open [index.html](./WEB%20PANEL/index.html) File and from [line number 16](https://github.com/hp322/tembm/blob/302dca641bb04c6bed72d1b2cebdfc79ccfbb046/WEB%20PANEL/index.html#L16) replace the config with your web app config which you have created on Step 6.
...
## tembm PRO <img src='WEB PANEL/img/logo.png' style="height:30px;width:30px;" >
